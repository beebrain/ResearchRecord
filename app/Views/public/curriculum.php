...
<body class="rr-grain bg-slate-50 text-slate-900 relative overflow-x-hidden">
                        ...
                        <article class="pub-item rounded-xl border border-slate-200 px-4 py-3 hover:bg-slate-50 transition-colors"
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                                ...
                                <div class="shrink-0 flex items-center gap-2">
                                    ...
                                    <?php if ($doi !== ''): ?>
                                        <a class="inline-flex items-center rounded-lg border border-slate-200 bg-white px-2.5 py-1.5 text-xs font-semibold text-slate-700 shadow-sm hover:bg-slate-50 hover:text-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all decoration-indigo-300"
    ...
    <script>
        (function () {
            ...
            var teacherMap = {};
            teacherBtns.forEach(function (b, idx) {
