-- ================================================================
-- CREATE publication_view 
-- สร้าง VIEW สำหรับ publications พร้อมข้อมูล authors, faculties, และ curriculum
-- ================================================================
--
-- ความต้องการ:
-- 1. Faculty Admin เห็น publications ของ:
--    - อาจารย์ในคณะของตน (user.faculty_id)
--    - อาจารย์ในหลักสูตรภายใต้คณะ (ผ่าน teacher_curriculum) แม้อาจารย์อยู่นอกคณะ
-- 2. Super Admin เห็น publications ทั้งหมด
--
-- Note: การกรองตาม role จะทำใน application layer (Controller/Model)
--       VIEW นี้จะรวมข้อมูลทั้งหมดไว้ให้พร้อมใช้งาน
-- ================================================================
